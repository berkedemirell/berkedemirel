    ...
    <div className=" bg-bblack h-screen font-texturina relative border-b border-slate-700">
      <div className="flex flex-row relative">
        <div className=" absolute ml-14 container flex flex-col items-start">
          <div className="text-3xl flex flex-row items-start mt-36 justify-start flex font-bold text-slate-200 ssm:text-2xl">
            <p>Hi, I am</p>
          ...
          <div className="text-slate-300 lg:text-slate-50 w-header">
            <p className="text-md font-bold mt-2 ssm:text-sm">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Laboriosam exercitationem earum quod possimus corrupti nemo culpa
              ducimus laudantium nostrum et?
            </p>
          </div>
          <Link className="text-slate-50 ssm:text-sm mt-44 border flex flex-row items-center justify-center border-slate-50 p-4 hover:bg-slate-50 hover:text-bblack font-bold transition-all duration-500 gap-2">
            Learn More{" "}
